...
task update_league_tables: :environment do
  ...
  Season.update_teams(LeagueTableScrapper.get_team_data(first_team_table.url), first_team_table)
  Season.update_teams(LeagueTableScrapper.get_team_data(reserve_team_table.url), reserve_team_table)
end
