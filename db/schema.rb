...
ActiveRecord::Schema.define(version: 20170722203609) do
  ...
  create_table "team_competitions", force: :cascade do |t|
    ...
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
    t.index ["competition_id"], name: "index_team_competitions_on_competition_id", using: :btree
    t.index ["team_id"], name: "index_team_competitions_on_team_id", using: :btree
  end
